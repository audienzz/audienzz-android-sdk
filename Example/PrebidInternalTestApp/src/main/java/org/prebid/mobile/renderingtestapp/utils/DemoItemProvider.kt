 ...
 *
 * Changelog:
 * - Remove all keyword const for R.id values
 */
...
class DemoItemProvider private constructor() {
    ...
    companion object {
        ...
        private val ppmBannerAction = R.id.action_header_bidding_to_in_app_banner
        private val ppmBannerSpecialSymbolsAction = R.id.action_header_bidding_to_in_app_banner_special_symbols
        private val ppmBannerActionMemoryLeakTesting =
            R.id.action_header_bidding_to_in_app_banner_memory_leak_testing
        private val ppmBannerPluginEventListenerAction = R.id.action_header_bidding_to_in_app_banner_plugin_event_listener
        private val ppmBannerPluginRendererAction = R.id.action_header_bidding_to_in_app_banner_plugin_renderer
        private val ppmInterstitialAction = R.id.action_header_bidding_to_in_app_interstitial
        private val ppmInterstitialMultiformatAction =
            R.id.action_header_bidding_to_in_app_interstitial_multiformat
        private val ppmInterstitialCloseButtonAreaAction =
            R.id.action_header_bidding_to_in_app_interstitial_close_button_area
        private val ppmInterstitialSoundButtonAction =
            R.id.action_header_bidding_to_in_app_interstitial_sound_button
        private val ppmInterstitialSkipButtonAction =
            R.id.action_header_bidding_to_in_app_interstitial_skip_button
        private val ppmInterstitialPluginEventListenerAction = R.id.action_header_bidding_to_in_app_interstitial_plugin_event_listener
        private val ppmInterstitialPluginRendererAction = R.id.action_header_bidding_to_in_app_interstitial_plugin_renderer
        private val ppmRewardedAction = R.id.action_header_bidding_to_in_app_video_rewarded
        ...
        private val adMobBannerAction = R.id.action_header_bidding_to_admob_banner
        private val adMobRandomBannerAction =
            R.id.action_header_bidding_to_admob_random_banner
        private val adMobFlexibleBannerAction =
            R.id.action_header_bidding_to_admob_flexible_banner
        private val adMobInterstitialAction = R.id.action_header_bidding_to_admob_interstitial
        private val adMobInterstitialMultiformatAction =
            R.id.action_header_bidding_to_admob_interstitial_multiformat
        private val adMobInterstitialRandomAction =
            R.id.action_header_bidding_to_admob_interstitial_random
        private val adMobRewardedAction = R.id.action_header_bidding_to_admob_rewarded
        private val adMobRewardedRandomAction =
            R.id.action_header_bidding_to_admob_rewarded_random
        private val adMobNativeAction = R.id.action_header_bidding_to_admob_native
        ...
        private fun addInAppPbsExamples() {
            ...
            demoList.add(
                DemoItem(
                    getString(R.string.demo_bidding_in_app_banner_320_50_special_symbols),
                    ppmBannerSpecialSymbolsAction,
                    ppmBannerTagList,
                    createBannerBundle(
                        R.string.imp_prebid_id_banner_320x50,
                        null,
