...
import org.prebid.mobile.prebidkotlindemo.view.adapter.BannerRenderingLazyAdapter

class GamRenderingApiDisplayBanner320x50LazyActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val adapter = BannerRenderingLazyAdapter()
